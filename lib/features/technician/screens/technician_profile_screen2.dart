...
class TechnicianProfileScreen1 extends StatelessWidget {
  const TechnicianProfileScreen1({super.key});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            "متخصص في كافة أعمال  والكهرباء المنزلية بخبرة تزيد عن 10 عاماً. ألتزم بتقديم أعلى مستويات الجودة والدقة في العمل، مع ضمان السرعة في التنفيذ والالتزام بالمواعيد. هدفي هو تقديم حلول عملية ومستدامة تلبي احتياجات العملاء بأفضل الأسعار.",
            style: GoogleFonts.cairo(
              fontSize: 14,
              color: textGrey,
      ...
      children: [
        ...
        SizedBox(
          ...
          child: ListView(
            ...
            children: [
              _buildGalleryImage(
                'assets/Gemini_Generated_Image_3d0qcu3d0qcu3d0q.png',
              ), // استبدلها بمسار صورتك
              const SizedBox(width: 12),
              _buildGalleryImage(
                'assets/Gemini_Generated_Image_lzoowwlzoowwlzoo.png',
              ),
              // تقدر تزود صور هنا
            ],
          ),
