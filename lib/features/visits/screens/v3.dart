...
class BasseytaApp13 extends StatelessWidget {
  const BasseytaApp13({super.key});
              ...
              Stack(
                ...
                children: [
                  ClipRRect(
                    ...
                    child: Image.asset(
                      'assets/Background (16).png', // تأكد من مسار الصورة
                      width: 85,
                      height: 85,
                      fit: BoxFit.cover,
                    ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 4),
          const Text(
            "تسرب مستمر للمياه أسفل حوض المطبخ، مع انخفاض ملحوظ في ضغط المياه عند فتح أكثر من صنبور، وظهور رطوبة على الجدار المجاور للحوض",
          ...
          Container(
            ...
            child: Column(
              ...
              children: const [
                ...
                SizedBox(height: 8),
                Text(
                  "ًتم استبدال الوصلات التالفة أسفل الحوض بأخرى جديدة عالية الجودة، وإصلاح موضع التسرب، مع تنظيف خط المياه وإعادة ضبط ضغط التغذية لضمان تدفق مستقر ومنع حدوث تسربات مستقبلية.",
            ...
            children: [
              Expanded(
                child: _buildBeforeAfterImage(
                  'قبل الإصلاح',
                  'assets/Gemini_Generated_Image_wgpgpuwgpgpuwgpg.png',
                  isBefore: true,
                ),
              ),
              const SizedBox(width: 12),
              Expanded(
                child: _buildBeforeAfterImage(
                  'بعد الإصلاح',
                  'assets/Gemini_Generated_Image_3ri47d3ri47d3ri4.png',
                  isBefore: false,
                ),
              ),
            ],
