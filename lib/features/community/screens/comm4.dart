...
class PaintsPostModel {
  ...
  factory PaintsPostModel.fromMap(Map<String, dynamic> map, String documentId) {
    return PaintsPostModel(
      id: documentId,
...
// ==========================================
// 2. Main Community Screen (صفحة مجتمع الدهانات)
// ==========================================
class PaintsCommunityScreen extends StatefulWidget {
  const PaintsCommunityScreen({super.key});

  @override
  State<PaintsCommunityScreen> createState() => _PaintsCommunityScreenState();
}

class _PaintsCommunityScreenState extends State<PaintsCommunityScreen>
          ...
          onPressed: () {
            if (_tabController.index == 1) {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => const CreatePaintsQuestionScreen(),
                ),
              );
            } else {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => const CreatePaintsPostScreen(),
                ),
              );
            }
          },
    ...
    return Column(
      children: [
        ...
        Padding(
          ...
          child: Text(
            "أكبر تجمع للفنيين والمهتمين بأعمال الدهانات والتشطيبات الحديثة في مصر. نتبادل الخبرات والحلول الفنية وأفكار التصميم.",
  ...
  Widget _buildPostCard(PaintsPostModel post) {
...
class CreatePaintsPostScreen extends StatefulWidget {
  ...
  @override
  State<CreatePaintsPostScreen> createState() => _CreatePaintsPostScreenState();
}

class _CreatePaintsPostScreenState extends State<CreatePaintsPostScreen> {
  ...
  Future<void> _publishPost() async {
    ...
    try {
      ...
      PaintsPostModel newPost = PaintsPostModel(
...
// ==========================================
// 4. Create Question Screen (طرح سؤال متطور)
// ==========================================
class CreatePaintsQuestionScreen extends StatefulWidget {
  const CreatePaintsQuestionScreen({super.key});

  @override
  State<CreatePaintsQuestionScreen> createState() =>
      _CreatePaintsQuestionScreenState();
}

class _CreatePaintsQuestionScreenState
    extends State<CreatePaintsQuestionScreen> {
  final TextEditingController _contentController = TextEditingController();
  final Color brandBlue = const Color(0xFF62A1DF);
  bool _isLoading = false;
  ...
  Future<void> _publishQuestion() async {
    ...
    try {
      PaintsPostModel newQuestion = PaintsPostModel(
        authorName: displayName,
        authorRole: displayRole,
        time: "الآن",
        content: _contentController.text.trim(),
