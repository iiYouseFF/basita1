...
// ==========================================
// 2. Main Community Screen (صفحة مجتمع التكييف الرئيسية)
// ==========================================
class acCommunityScreen extends StatefulWidget {
  const acCommunityScreen({super.key});

  @override
  State<acCommunityScreen> createState() => _acCommunityScreenState();
}

class _acCommunityScreenState extends State<acCommunityScreen>
                ...
                children: [
                  ...
                  Expanded(
                    child: StreamBuilder<QuerySnapshot>(
                      stream: MockFirestore.collection('post_ac')
                          .doc(postId)
                          .collection('comments')
    ...
    return Column(
      children: [
        ...
        Padding(
          ...
          child: Text(
            "أكبر تجمع للفنيين والمهتمين بأعمال التكييف والتبريد وأنظمة التهوية الحديثة في مصر. نتبادل الخبرات والحلول الفنية.",
...
// ==========================================
// 3. Create Electricity Post Screen (إنشاء منشور التكييف مع dynamic)
// ==========================================
...
class _CreateElectricityPostScreenState
  ...
  void _fetchUserDataFromSession() {
    ...
    setState(() {
      ...
      displayName = rawName.isNotEmpty ? rawName : "أحمد محمود";
  ...
  Future<void> _publishPost() async {
    ...
    try {
      ...
      if (_selectedImage != null) {
        final fileName = 'ac_post_${DateTime.now().millisecondsSinceEpoch}.jpg';
      ...
      // 4. الحفظ في فايربيز (مجموعة التكييف)
      await MockFirestore.collection('post_ac').add(newPost.toMap());
...
// ==========================================
// 4. Create Electricity Question Screen (طرح سؤال التكييف)
// ==========================================
...
class _CreateElectricityQuestionScreenState
  ...
  Future<void> _publishQuestion() async {
    ...
    try {
      ...
      await MockFirestore.collection('post_ac').add(newQuestion.toMap());
