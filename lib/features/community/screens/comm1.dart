...
class PostModel {
  ...
  final List<String> likedBy; // قائمة المستخدمين الذين قاموا بالإعجاب
...
// ==========================================
// 2. Main Community Screen (صفحة المجتمع الرئيسية)
// ==========================================
class CommunityScreen extends StatefulWidget {
  const CommunityScreen({super.key});

  @override
  State<CommunityScreen> createState() => _CommunityScreenPerfectState();
}

class _CommunityScreenPerfectState extends State<CommunityScreen>
  ...
  Widget _buildPostsList() {
    ...
    // دالة مساعدة لتحديد عرض صورة البروفيسور بأمان (سواء رابط أو ملف محلي)
            ...
            child: Row(
              children: [
                CircleAvatar(
                  radius: 18,
                  backgroundColor: Colors.grey.shade200,
                  backgroundImage: getProfileImage(userProfileImage),
                ),
    ...
    return Column(
      children: [
        ...
        Padding(
          ...
          child: Text(
            "أكبر تجمع للفنيين والمهتمين بأعمال السباكة الحديثة وتكنولوجيا المياه في مصر. نتبادل الخبرات والحلول التقنية.",
  ...
  Future<void> _publishPost() async {
    ...
    try {
      ...
      PostModel newPost = PostModel(
        ...
        imagePath:
            imageUrl, // تمرير الرابط السحابي السليم بدلاً من المسار المحلي
        likes: 0,
        comments: 0,
        isQuestion: false,
        likedBy: [],
...
// ==========================================
// 4. Create Question Screen (طرح سؤال)
// ==========================================
...
class _CreateQuestionScreenState extends State<CreateQuestionScreen> {
  ...
  Future<void> _publishQuestion() async {
    ...
    try {
      PostModel newQuestion = PostModel(
        authorName: displayName,
        authorRole: displayRole,
        time: "الآن",
        content: _contentController.text.trim(),
