...
// ==========================================
// 2. Main Community Screen (صفحة مجتمع الكهرباء)
// ==========================================
class ElectricityCommunityScreen extends StatefulWidget {
  const ElectricityCommunityScreen({super.key});

  @override
  State<ElectricityCommunityScreen> createState() =>
      _ElectricityCommunityScreenState();
}

class _ElectricityCommunityScreenState extends State<ElectricityCommunityScreen>
  ...
  // --- دالة مساعدة لعرض صورة البروفيسور بأمان (سواء رابط أو ملف محلي) ---
                ...
                children: [
                  ...
                  Expanded(
                    child: StreamBuilder<QuerySnapshot>(
                      stream: MockFirestore.collection('post_electricity')
                          .doc(postId)
                          .collection('comments')
    ...
    return Column(
      children: [
        ...
        Padding(
          ...
          child: Text(
            "أكبر تجمع للفنيين والمهتمين بأعمال الكهرباء الحديثة والشبكات الذكية في مصر. نتبادل الخبرات والحلول التقنية.",
        ...
        children: [
          Row(
            children: [
              ...
              // --- قائمة خيارات المنشور (تحتوي خيار الحذف) ---
          ...
          // 👇 عرض صورة المنشور بذكاء (سواء رابط سحابي أونلاين أو مسار محلي)
...
class _CreateElectricityPostScreenState
  ...
  Future<void> _publishPost() async {
    ...
    try {
      ...
      // 3. إنشاء الكائن بالرابط السحابي
      ElectricityPostModel newPost = ElectricityPostModel(
        ...
        imagePath: imageUrl, // تمرير الرابط السحابي السليم
        likes: 0,
        comments: 0,
        isQuestion: false,
        likedBy: [],
      ...
      await MockFirestore.collection('post_electricity').add(newPost.toMap());
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            ...
            // الشريط السفلي (الأدوات والخيارات)
            Container(
...
// ==========================================
// 4. Create Question Screen (إنشاء أسئلة الكهرباء)
// ==========================================
